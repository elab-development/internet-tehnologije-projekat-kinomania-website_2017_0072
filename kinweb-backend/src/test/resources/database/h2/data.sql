...
INSERT INTO country(id,name,official_state_name,code) VALUES (1,'Afghanistan','The Islamic Republic of Afghanistan','AF'),
...
(5,'Dummy media','2023-08-17',NULL,'a',15,NULL);
...
INSERT INTO acting(media_id,actor_id,is_starring) VALUES (1,2,1),
(1,3,1),
(1,4,1),
(1,5,0),
(1,6,0),
...
INSERT INTO acting_role(acting_media_id,acting_actor_id,id,name) VALUES (1,2,1,'Betty Elms'),
(1,2,2,'Diane Selwyn'),
(1,3,1,'Rita'),
