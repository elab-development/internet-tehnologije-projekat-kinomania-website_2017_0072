...
@Transactional
public class DirectorRepositoryJDBCTest {

    @Autowired
    private DirectorRepositoryJDBC repo;
...
//=================================================================================================
    ...
    @Test
    @Order(1)
    @DisplayName("Tests normal functionality of findAllByMediaId method of DirectorRepositoryJDBC class")
    void findAllByMediaId_Test() {
        ...
        List<DirectorJDBC> expected;
        List<DirectorJDBC> actual;
        for (MediaJDBC media : init.getMedias()) {
            expected = media.getDirectors();
    ...
    @Test
    @Order(2)
    @DisplayName("Tests normal functionality of existsById method of DirectorRepositoryJDBC class")
    void existsById_Test() {
        ...
        long id;
        boolean actual;
        for (DirectorJDBC director : init.getDirectors()) {
            actual = repo.existsById(director.getId());
...
//==============================================================================================================
    ...
    private void checkValues(List<DirectorJDBC> actual, List<DirectorJDBC> expected) {
