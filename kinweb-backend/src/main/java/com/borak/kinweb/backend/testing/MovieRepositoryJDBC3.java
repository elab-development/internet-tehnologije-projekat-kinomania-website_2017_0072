 ...
 */
package com.borak.kinweb.backend.testing;
...
import com.borak.kinweb.backend.testing.IMovieRepository3;

/**
 *
 * @author Mr. Poyo
 */
public class MovieRepositoryJDBC3 implements IMovieRepository3<MovieJDBC, GenreJDBC, DirectorJDBC, WriterJDBC, ActorJDBC, ActingJDBC, Long> {
...
//    }
    @Override
    public void update(MovieJDBC movie) throws DatabaseException {
        try {
            performUpdate(movie);
        } catch (DataAccessException e) {
