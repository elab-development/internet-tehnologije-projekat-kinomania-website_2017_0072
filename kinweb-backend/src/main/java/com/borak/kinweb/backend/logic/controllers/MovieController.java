...
//    ConfigProperties properties;
    ...
    public ResponseEntity<MoviePOSTRequestDTO> postMovie(@RequestPart("movie") MoviePOSTRequestDTO movie,@RequestPart(name = "cover_image",required = false) MultipartFile coverImage) {
        //TODO
        movie.setCoverImage(coverImage);
        domainValidator.validatePOST(movie);
        movie.setCoverImage(null);
