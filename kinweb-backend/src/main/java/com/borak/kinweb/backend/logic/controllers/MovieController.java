...
public class MovieController {
    ...
    //=========================POST MAPPINGS==================================
    @PostMapping
    public ResponseEntity<MovieDTO> postMovie(@Valid @RequestBody MovieDTO movie,@RequestParam(name = "cover_image") MultipartFile coverImage) {
        System.out.println("Content type: "+coverImage.getContentType());    
