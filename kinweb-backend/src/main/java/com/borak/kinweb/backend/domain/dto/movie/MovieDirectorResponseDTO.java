...
public class MovieDirectorResponseDTO implements DTO {
    ...
    public MovieDirectorResponseDTO() {
    }

    public MovieDirectorResponseDTO(Long id, String firstName, String lastName, String profilePhotoUrl, Gender gender) {
        this.id = id;
