...
public class MovieWriterResponseDTO implements DTO {
    ...
    public MovieWriterResponseDTO() {
    }

    public MovieWriterResponseDTO(Long id, String firstName, String lastName, String profilePhotoUrl, Gender gender) {
        this.id = id;
