...
//   const data = {
//     data: { movies: [], shows: [] },
//     loading: { loadingMovies: true, loadingShows: true },
//     error: { errorMovies: null, errorShows: null },
//   };

//   axios
//     .get(BASE_URL + `/api/movies/popular?page=${page}&size=${size}`)
//     .then()
//     .catch()
//     .finally();
...
//     axios
//       .get(BASE_URL + "/api/movies/popular", {
//         headers,
//       })
//       .then((response1) => {
